# This cmdlet will help you to extract the group membership for a list of users .
# 1 ) Save a list of users as CSV 
# 2 ) Dont forget that first collum of the CSV must contain UserLoginID
# 3 ) Put all names under UserLoginID and save the CSV
# 4 ) Run the code.\Multi_Usergroup.ps1 -CSVFile "C:\Location of the CSV" - Results will be posted on your desktop
